...
_REVIEW_MSG = {
    "ru": {
        ...
        "btn": "Оставить отзыв",
        "sms": "Здравствуйте! 🐾\n\nМы совсем молодой салон R&J Grooming и сейчас собираем отзывы наших первых клиентов ❤️\n\nЕсли вам понравился наш уход и вы остались довольны, будем очень благодарны, если вы оставите небольшой отзыв о нас в Google: {link}\n\nСпасибо, что выбираете R&J Grooming! 🤍",
    },
    "en": {
...
def cron_review_request():
    ...
    if test_sms:
        ...
        sms_text = (f"[ТЕСТ] Здравствуйте! 🐾\n\nМы совсем молодой салон R&J Grooming и сейчас собираем отзывы "
                    f"наших первых клиентов ❤️\n\nЕсли вам понравился наш уход и вы остались довольны, будем "
                    f"очень благодарны, если вы оставите небольшой отзыв о нас в Google: {review_link}\n\n"
